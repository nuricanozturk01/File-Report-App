...
#pragma warning restore CS8602
        ...
        public static bool HasAccessAllowFile(string folder, params FileSystemRights[] rights)
        {
            bool hasAccess = false;
...
#pragma warning restore CS8600 
            ...
            var dirInfo = new FileInfo(folder);

            FileSecurity dirSec = dirInfo.GetAccessControl();
